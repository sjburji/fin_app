...
set :application, "fin_app"
set :repository,  "git://github.com/sjburji/fin_app.git"

set :scm, :git

set :deploy_to, "/disk1/fin_app"
set :user, 'rails'
...
# these http://github.com/rails/irs_process_scripts
  namespace :deploy do
    task :copy_database_configuration do 
      production_db_config = "/disk1/fin_app/database.yml" 
  ...
  namespace :deploy do
    task :copy_mail_configuration do 
      production_mail_config = "/disk1/fin_app/setup_mail.rb" 
